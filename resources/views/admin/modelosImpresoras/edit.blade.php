            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <form method="POST" action="{{route('modelosImpresoras.update', $modeloimp->id)}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nombre" class="form-control" value="{{ $modeloimp->nombre }}"
                                        required>
                                </div>
                            </div>
